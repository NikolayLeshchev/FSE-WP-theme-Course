...
/*!***********************************************!*\
  ...
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @mui/material */ "./node_modules/@mui/material/Rating/Rating.js");
...
function RecipeRating(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_0__["default"], {
    value: avgRating,
    precision: 0.5,
    onChange: async (event, rating) => {
      if (!permission) {
        return alert('You have already rated this recipe or you should log in.');
      }
      setPermission(false);
