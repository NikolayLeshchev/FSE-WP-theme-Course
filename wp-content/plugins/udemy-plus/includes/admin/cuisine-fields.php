...
function up_cuisine_add_form_fields() {
    ...
    <div class="form-field">
        ...
        <p><?php _e('A URL a user can click to learn more information.', 'udemy-plus'); ?></p>
    </div>
...
function up_cuisine_edit_form_fields($term){
    ...
    <tr class="form-field">
        ...
        <td>
           ...
           <p class="description"><?php _e('A URL a user can click to learn more information.', 'udemy-plus'); ?></p> 
        </td>
    </tr>
    <?php
}